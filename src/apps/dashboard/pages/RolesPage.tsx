...
import { PERMISSIONS, applyCascade, ROLE_LABEL, MOCK_PROFILES, type PermKey } from '@/apps/dashboard/lib/permissionMeta'
...
export function RolesPage() {
  ...
  function toggle(role: EmployeeRole, key: PermKey, value: boolean) {
    setMatrix(prev => {
      if (!prev) return prev
      return { ...prev, [role]: applyCascade(prev[role], key, value) }
    })
